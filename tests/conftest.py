...
def load_env_vars():
    ...
    try:
        ...
        tests_env_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "tests", ".env")
...
def egnyte_credentials():
    ...
    if not domain or not user_token:
        pytest.skip("Egnyte credentials not available. Set EGNYTE_DOMAIN and EGNYTE_USER_TOKEN environment variables.")
...
def skip_if_no_credentials():
    ...
    if not domain or not user_token:
        pytest.skip("Integration tests require EGNYTE_DOMAIN and EGNYTE_USER_TOKEN environment variables")
